...
class Individu():
    ...
    def play(self):
      ...
      c_in_game=True
      winner=False
      player_list=[PROBA_ARRAY[random.randint(0,12)]]
      croupier_list=[PROBA_ARRAY[random.randint(0,12)]]
      ...
      while p_in_game or c_in_game :
        ...
        if p_in_game: #le joueur decide si il joue ou stop
          ...
          if self.chromosomes[choice]==1 :
            player_list.append(PROBA_ARRAY[random.randint(0,12)])
          else:
            p_in_game=False
        ...
        if croupier_val<17 and c_in_game:
          croupier_list.append(PROBA_ARRAY[random.randint(0,12)])
        else:
          c_in_game=False
